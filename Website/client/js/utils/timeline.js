...
// æ”¹è¿™ä¸ªpartå°±å¥½ä¸­é—´çš„æ•°æ®å¤„ç†é€»è¾‘æˆ‘éƒ½å†™å¥½äº† ä½ å†™å¥½å¯¼å…¥åˆ°è¿™å‡ ä¸ªæ•°åˆ—é‡Œå°±è¡Œ
/* var DATA = {
  "Brazil": {
...
function colorFromValue01(v) {
  ...
  var S = 60;                // more vivid
  var L = 90 - num * 55;     // light green â†’ darker yellow-green
  ...
  for (var i = 0; i < COUNTRIES.length; i++) {
    ...
    if (layer) {
      ...
      layer.eachLayer(function (shape) {
        shape.unbindTooltip();
        var txt = name + " â€¢ " + metric + ": " + (envVal == null ? "n/a" : envVal.toFixed(2));
