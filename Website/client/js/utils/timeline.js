// Timeline feature code
/* ===================== 1) Data (by country name) ===================== */
...
const ZOOM_TWEAK = { Brazil: 0.0, Poland: 0.25, "South Korea": 0.55 };
const PAD_TWEAK  = { Brazil: 0,   Poland: -4,   "South Korea": -8 };
...
function updateLegend() {
  const left  = colorFromValue01(0);
  const right = colorFromValue01(1);
...
const CASH_PER_ROW   = 12;
const NOTE_SPACING_X = 20;
const NOTE_SPACING_Y = 38;
const NOTE_WIDTH_PX  = 30;
